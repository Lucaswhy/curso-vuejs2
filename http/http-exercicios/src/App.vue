<template>
	<div id="app" class="container">
		...
		<b-card>
			...
			<b-button @click="obterUsuarios()" size="lg" variant="secondary" class="ml-2">Obter Usuários</b-button>
		</b-card>
		<hr>
			<b-list-group>
				<b-list-group-item v-for="(usuario, id) in usuarios" :key="id" class="mt-2">
